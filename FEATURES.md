...
| Rotating thinking words | `src/tui/render.rs:THINKING_WORDS` | 12-word rotation (Thinking, Analyzing, Planning, Reasoning…) replaces the static "Thinking…"; tool-running shows context-aware verb (Reading, Writing, Editing, Searching…) + truncated file label in chat, status bar, and sidebar; word changes every ~1.3s at 16ms tick |
