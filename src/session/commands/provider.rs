...
impl Session {
    pub fn cmd_provider(&mut self, config: &Config) {
        ...
        let providers: Vec<ProviderDef> = vec![
            ProviderDef { slug: "lm_studio",  name: "LM Studio",                  hint: "local · OpenAI-compatible",                    kind: ProviderKind::OpenAi,    models: &["gemma-4-e4b-it", "qwen2.5-coder-7b-instruct", "mistral-7b-instruct", "Other…"],    base_url: Some("http://localhost:1234/v1/chat/completions"),                                    needs_key: false, coming_soon: false, auth_header: None,       ready: lm_studio_ready },
