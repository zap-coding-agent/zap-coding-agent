...
impl Session {
    pub fn cmd_provider(&mut self, config: &Config) {
        ...
        let providers: Vec<ProviderDef> = vec![
            ...
            ProviderDef { slug: "deepseek",   name: "DeepSeek",                   hint: "deepseek-chat / deepseek-reasoner",            kind: ProviderKind::OpenAi,    models: &["deepseek-chat", "deepseek-reasoner", "Other…"],                                     base_url: Some("https://api.deepseek.com/v1/chat/completions"),                                needs_key: true,  coming_soon: false },
